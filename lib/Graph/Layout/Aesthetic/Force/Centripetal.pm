package Graph::Layout::Aesthetic::Force::Centripetal;
use 5.006001;
use strict;
use warnings;
...
The aesthetic force is that nodes are repelled from the center of gravity
(the centroid) with a force that's inverse to their distance from that center.
